      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl card p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-konkan-sand rounded-lg text-sm text-konkan-text-primary hover:bg-konkan-cream transition-colors">
